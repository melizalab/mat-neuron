...
class TestMatModel(unittest.TestCase):
    ...
    def test_step_response(self):
        ...
        self.assertAlmostEqual(
            Y[-1, 0], I[-1] * params[5], msg="incorrect steady-state voltage"
        )
    ...
    def test_likelihood_upsample(self):
        ...
        llVds = log_likelihood_poisson(
            V[::2], H, spk_v, params_true[:2], dt, upsample=2
        )
    ...
    def test_likelihood_nomembrane(self):
        ...
        spikes = model.predict_poisson(
            V - omega, (a1, a2), (t1, t2), tref, dt, upsample
        )
        spike_t = spikes.nonzero()
        adapt = model.adaptation(spikes, (t1, t2), dt)

        llf = model.log_likelihood_poisson(
            V - omega, adapt, spikes, (a1, a2), dt, upsample
        )
